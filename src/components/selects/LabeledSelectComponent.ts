...
export class LabeledSelectComponent extends SelectComponent implements IFieldNameValidator {
  private label: string;

  /**
   * Initializes a new LabeledSelectComponent instance.
   *
   * Creates a labeled select component that targets Frappe form controls by their data field name.
   ...
   * @param {string} label - The human-readable label for this select field.
  ...
  constructor(
    ...
    const field_locator = page
      ...
      .locator(enabled ? 'select' : '.like-disabled-input');
   ...
   * matches the label configured for this component instance. This ensures
